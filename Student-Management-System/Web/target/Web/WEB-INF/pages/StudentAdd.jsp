...
<head>
    ...
    <script>
      function add() {
          $.post("/student/StudentAdd",$("form").serialize(),function (data) {
              $("#add-div-span").text(data+"   点击刷新页面");
              $("#add-div").show();
          },"text")
      }
    </script>
...
<%--添加成功提示框--%>
<div class="alert alert-success" role="alert" id="add-div">
    <a href="${pageContext.request.contextPath}/student/StudentfindAll" class="alert-link"><span id="add-div-span"></span></a>
</div>
        ...
        <div class="tab1">
            ...
            <div class="tab3">
                <form  class="form-horizontal" method="post" action="/student/StudentAdd">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10" >
                            <input  type="text" class="form-control" id="profession" placeholder="专业" name="profession">
                        </div>
                    </div>
                    <div class="form-group">
