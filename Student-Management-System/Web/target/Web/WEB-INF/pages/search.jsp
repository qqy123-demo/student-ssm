    ...
    <table class="table table-bordered" id="tab" >
        ...
        <tbody>
            <tr >
                <td>
                    <label>
                        <input type="checkbox" name="check" value="${Search.id}">
                    </label>
                </td>
                <td name="id">${Search.id}</td>
                <td >${Search.name}</td>
                <td >${Search.age}</td>
                <td >${Search.gender}</td>
                <td >${Search.address}</td>
                <td >${Search.profession}</td>
                <td >${Search.grade}</td>
                <td>
                    <a class="btn btn-default" href="${pageContext.request.contextPath}/student/TOupdate_jsp?id=${Search.id}" role="button">编辑</a>
